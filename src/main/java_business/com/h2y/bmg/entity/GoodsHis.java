...
/**
 * 类描述：商品历史表 作者：侯飞龙 时间：2015年1月26日下午3:03:47 邮件：1162040314@qq.com
 */
public class GoodsHis extends BaseObject {

	/**
	 * @Fields serialVersionUID : TODO(用一句话描述这个变量表示什么)
	 */
	private static final long serialVersionUID = 1L;
	public static final String key = "keyGoodsHis";
	private long id;
	...
	public GoodsHis(long id) {
		super();
		this.id = id;
	}

	public GoodsHis(long id, long goodsId, long goodsTypeId, String gdsCode,
			String gdsCode2, String goodsNumber, String shortGoodsNumber,
			String goodsName, int inventory, int goodsUnit, int spec,
	...
	public String toString() {
		return "id:" + id + "\t" + "goodsId:" + goodsId + "\t" + "goodsTypeId:"
				...
				+ "goodsName:" + goodsName + "\t" + "inventory:" + inventory
