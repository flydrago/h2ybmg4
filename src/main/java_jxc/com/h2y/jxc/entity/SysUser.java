...
public class SysUser extends BaseObject{
	...
	public SysUser(long id,long unitId,String userName,String account,String password,String mobile,String email,String userCord,Date updateDate,long ifLock,long ifSys,long ifDelete,long userOrd,long reverse1,String reverse2,String reverse3){
		super();
		this.id = id;
		this.unitId = unitId;
	...
	return "id:"+id+"\t"+"unitId:"+unitId+"\t"+"userName:"+userName+"\t"+"account:"+account+"\t"+"password:"+password+"\t"+"mobile:"+mobile+"\t"+"email:"+email+"\t"+"userCord:"+userCord+"\t"+"updateDate:"+updateDate+"\t"+"ifLock:"+ifLock+"\t"+"ifSys:"+ifSys+"\t"+"ifDelete:"+ifDelete+"\t"+"userOrd:"+userOrd+"\t"+"reverse1:"+reverse1+"\t"+"reverse2:"+reverse2+"\t"+"reverse3:"+reverse3;
    }
}