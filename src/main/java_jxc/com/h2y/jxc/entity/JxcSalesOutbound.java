...
public class JxcSalesOutbound extends BaseBill{

	/**
	 * @Fields serialVersionUID
	 */
	private static final long serialVersionUID = 1L;	
    public static final String key = "keyJxcSalesOutbound";
    private long id;
	...
	public JxcSalesOutbound(){
		super();
	}

	public JxcSalesOutbound(long id){
		super();
		this.id = id;
	}

	public JxcSalesOutbound(long id,String billNo,String billCustomNo,Date outboundDate,Date proceedsDate,long customerId,String customer,long storageId,String storage,String storageArea,long brokerId,String broker,long proceedsAccountId,String proceedsAccount,Double currentProceeds,String notes,int reviseMark,int checkStatus,int billStatus,Double totalAmount,Double discount,Double discountAmount,Double receivableAmount,String billMaker,Date createDate,String zoneCode,String data1,String data2,String data3,String data4,long data5,long data6,long data7,long data8){
		super();
		this.id = id;
		this.billNo = billNo;
