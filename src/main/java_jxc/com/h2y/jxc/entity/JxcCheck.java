...
public class JxcCheck extends BaseBill{

	/**
	 * @Fields serialVersionUID
	 */
	private static final long serialVersionUID = 1L;	
    public static final String key = "keyJxcCheck";
    private long id;
	...
	public JxcCheck(long id){
		super();
		this.id = id;
	}

	public JxcCheck(long id,String billNo,String billCustomNo,Date checkDate,long storageId,String storage,long brokerId,String broker,String notes,int breakevenCount,int stockCount,int checkCount,Double breakevenAmount,int checkStatus,int billStatus,String billMaker,Date createDate,String zoneCode,String data1,String data2,String data3,long data4,long data5,long data6,int data7,int data8,Double data9,Double data10){
		super();
		this.id = id;
		this.billNo = billNo;
	...
	return "id:"+id+"\t"+"billNo:"+billNo+"\t"+"billCustomNo:"+billCustomNo+"\t"+"checkDate:"+checkDate+"\t"+"storageId:"+storageId+"\t"+"storage:"+storage+"\t"+"brokerId:"+brokerId+"\t"+"broker:"+broker+"\t"+"notes:"+notes+"\t"+"breakevenCount:"+breakevenCount+"\t"+"stockCount:"+stockCount+"\t"+"checkCount:"+checkCount+"\t"+"breakevenAmount:"+breakevenAmount+"\t"+"checkStatus:"+checkStatus+"\t"+"billStatus:"+billStatus+"\t"+"billMaker:"+billMaker+"\t"+"createDate:"+createDate+"\t"+"zoneCode:"+zoneCode+"\t"+"data1:"+data1+"\t"+"data2:"+data2+"\t"+"data3:"+data3+"\t"+"data4:"+data4+"\t"+"data5:"+data5+"\t"+"data6:"+data6+"\t"+"data7:"+data7+"\t"+"data8:"+data8+"\t"+"data9:"+data9+"\t"+"data10:"+data10;
    }
}