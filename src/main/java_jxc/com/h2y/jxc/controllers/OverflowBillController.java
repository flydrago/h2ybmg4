...
import com.h2y.jxc.services.IJxcOverflowService;
...
@Controller
@Scope("prototype")
@RequestMapping("jxc/overflow")
public class OverflowBillController extends BaseController{

	@Autowired
	protected IJxcOverflowService jxcOverflowService;
	...
	public ModelAndView init(){
		...
		view.setViewName("jxc/overflow/init");
	...
	public void getList(){
		outJson(jxcOverflowService.getGridData(request));
	}
	...
	public ModelAndView add(@ModelAttribute JxcOverflow overflowBill,@RequestParam String op ){
		...
		String billNo = "BYD-"+day+"-"+minutes+randomNum;
		...
		view.setViewName("jxc/overflow/add");
	...
	public void save(){
		...
		outJson(jxcOverflowService.save(reqMap));
	}
	...
	public ModelAndView getOverflowBillDetail(Long billId){
		...
		JxcOverflow billDetail  =  jxcOverflowService.get(billId);
		...
		view.setViewName("jxc/overflow/detail");
