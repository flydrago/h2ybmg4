...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "business/unitsort/getList.htm";
    ...
    function f_onSelect(node) {
    	...
    	if(!haschildren){
			$.ajax({
				type: "POST",
				url: "business/unitsort/getTreeList.htm",
				data: {id:id},
    ...
    function h2y_add() {
        ...
        var src = "<%=basePath%>business/unitsort/add.htm?op=add&parentId="+id;
        ...
        $.ligerDialog.open({
            ...
            buttons: [
                { text: '确定', onclick: function (item, dialog) {
                    f_getframe("unitsort_add").h2y_save();
                } },
    ...
    function h2y_modify() {
        ...
        var src = "<%=basePath%>business/unitsort/add.htm?op=modify&id="+rows[0].id;
        
        $.ligerDialog.open({
            name:"unitsort_modify",
            title:  "修改类型",
            height: 340,
            url: src,
            width: 700,
            ...
            buttons: [
                { text: '确定', onclick: function (item, dialog) {
                    f_getframe("unitsort_modify").h2y_save();
                } },
                { text: '取消', onclick: function (item, dialog) {
                    dialog.close();
                } }
    ...
    function h2y_delete() {
        ...
        $.post("business/unitsort/delete.htm?id=" + rows[0].id, function (data) {
