...
<script type="text/javascript">
	...
	var dataType = "coupons";
    $(function () {
    	
    	//hwtt_setSqlCondition();

        $("#toptoolbar").ligerToolBar({items: [{ line:true },{ text: '添加优惠劵' , click: h2y_coupons , icon:'coupons' },{ line:true },{ text: '移除优惠劵' , click: h2y_delete , icon:'delete' },{ line:true },{ text: '刷新' , click: h2y_refresh , icon:'refresh' }]});
        $("#layout1").ligerLayout({
            leftWidth: 190,
            height: "100%",
            topHeight: 23,
    ...
    function h2y_coupons() {
    	...
    	openCouponsSelectDialog({
    		selectType:"multi",//多选
    		filterBean:"advertSubjectInfoRtService",//广告模块
    		data1:${subjectId},//广告主题id
    		isStart:"yes",//开始的优惠劵
    		data2:dataType //优惠劵选择
    	});
    }
