...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#toptoolbar").ligerToolBar({items: [{ line:true },{ text: '添加头部广告图' , click: h2y_img , icon:'add' },{ line:true },{ text: '移除头部广告图' , click: h2y_delete , icon:'delete' },{ line:true },{ text: '刷新' , click: h2y_refresh , icon:'refresh' }]});
        $("#layout1").ligerLayout({
            leftWidth: 190,
            height: "100%",
            topHeight: 23,
