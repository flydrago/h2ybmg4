...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#start_day").datepicker({ dateFormat: 'yy-mm-dd',changeYear: true,changeMonth:true });
        $("#end_day").datepicker({ dateFormat: 'yy-mm-dd',changeYear: true,changeMonth:true});
        
        $("#start_day").val(GetDateStr(-7));
        $("#end_day").val(GetDateStr(0));
    ...
    function f_getList() {
        ...
        var url_1 = "business/ordercount/getList.htm";

        $("#listgrid").ligerGrid({
            columns: gcolumns,
            url: url_1,
            parms:  [{name:"startDay",value:$("#start_day").val()},
                     {name:"endDay",value:$("#end_day").val()}],
            showTitle: false,
            dataAction: "server",
            pageSize: 20,
            height: "100%",
    ...
    function h2y_search(){
    	 ...
    	 if(!dayCheck(startDay,endDay)) return;
    	...
    	<div id="conditiondiv" style="align:center;padding-top:5px;padding-bottom:5px;">
    		<table id='id-querytable' class='css-querytable' >
    			<tr height='25px'>
    				...
    				<td colspan='1'  align='left' >
    					<input style='width:80px;' id='start_day'  name='start_day'   type='text'  value='' />~
    					<input style='width:80px;' id='end_day'  name='end_day'   type='text'  value='' />
    				</td>
    			</tr>
    		</table>
    	</div>
