...
<script type="text/javascript">
    ...
    $(function () {
		...
		$("#toptoolbar").ligerToolBar({
			items: [{ line:true },{ text: '查询' , click: h2y_search,icon:'search' },
			        ...
			        { line:true },{ text: '分配' , click: h2y_assign,icon:'ok' },
    ...
    //获取列表
    function f_getList() {
    	var paramString ="ifReceive=1&ifEnable=1&ifCreate=0&parentId=" + parentId + "&spec=" + spec;
    ...
    //添加
    function h2y_add() {
    	var paramString ="op=start_add&parentId=" + parentId + "&spec=" + spec;
        var src = "<%=basePath%>business/tracenumbersection/add.htm?" + paramString;
        
        $.ligerDialog.open({
            name:"business_tracenumbersection_start_add",
            title:  "添加启用号段",
            height: 300,
            url: src,
            width: 700,
            ...
            buttons: [
                { text: '保存', onclick: function (item, dialog) {
                    f_getframe("business_tracenumbersection_start_add").h2y_save();
                } },
        ...
        //top.f_addTab("business_tracenumbersection_start_add","添加启用号段", src);
    }
    ...
    function h2y_assign(){
         ...
         var src = "<%=basePath%>business/tracenumbersection/assignProvince.htm?" + paramString;
         top.f_addTab("assign_province_qr"+rows[0].ID,"省级代理二维码号段", src);
    }
