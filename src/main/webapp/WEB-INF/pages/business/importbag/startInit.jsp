...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "business/importbag/getStartList.htm";
    ...
    function h2y_delete() {
        ...
        $.post("business/importbag/delete.htm?bagCode=" + rows[0].bagCode, function (data) {
	...
	function h2y_user() {
        ...
        var src = "<%=basePath%>business/importbag/userInit.htm?bagCode="+rows[0].bagCode+"&op=edit";
    ...
    function h2y_start(){
    	...
    	<%--注意该处url可能不符合你的要求，请注意修改--%>
        $.post("business/importbag/save.htm", {op:"start",id:rows[0].id}, function (data) {
