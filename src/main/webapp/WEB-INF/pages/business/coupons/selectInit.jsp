...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "business/coupons/getSelectList.htm?op=grid";

        $("#listgrid").ligerGrid({
            columns: [${gridComluns}],
            url: url_1,
            parms: [{name:"sourceId",value:sourceId},{name:"isStart",value:isStart},{name:"filterBean",value:filterBean},{name:"data1",value:data1},{name:"data2",value:data2},{name:"data3",value:data3},{name:"data4",value:data4}],
            showTitle: false,
            dataAction: "server",
            pageSize: 20,
            height: "100%",
