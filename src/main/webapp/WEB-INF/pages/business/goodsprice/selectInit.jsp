...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "business/goodsprice/getSelectList.htm";
        ...
        $("#listgrid").ligerGrid({
            ...
            onDblClickRow: function (row, index, data) {
                //alert("行双击事件");
            	 parent.h2y_priceGoodsSelectCallBack(row);
    ...
    function h2y_search(){
    	...
    	var typeCode = $("#goodstype_select").val();
   ...
   function hwtt_do_change(obj){
	...
	function addselect(id,obj){
		...
		$.post("business/goodstype/getSelectList.htm",{id:id},function(data){
			...
			if(selectHtml!=""){
				selectHtml = "<select id=\"goodstype_select\" class=\"goodstype_select\"><option value=\"\"> </option>"+selectHtml+"</select>";
    ...
    <div position="center" title="">
    	...
    	<table id="id-querytable" class="css-querytable">
		    <tr height="25px">
		        ...
		        <td align="left">
		            <input class="h2y_input_just" id="goodsName" name="goodsName" type="text" value=""/>
		        </td>
		       <td align="right">
		                                 商品类型:
		        </td>
		        <td id="goodstype_td"  align="left">
