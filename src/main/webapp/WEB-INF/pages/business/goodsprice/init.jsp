...
<script type="text/javascript">
    ...
    function h2y_add() {
        ...
        var src = "<%=basePath%>business/goodsprice/add.htm?op=add";
        top.f_addTab("goodsprice_add","代理商品", src);
    }
	...
	//批量添加
	function h2y_add_batch(){
		var src = "<%=basePath%>business/goodsprice/addBatch.htm?op=addBatch";
        top.f_addTab("goodsprice_add_batch","批量添加", src);
	}
</script>
...
<div id="layout1" style="width: 100%">
	...
	<input type="text" name="goodsSource" id="goodsSource" value="${goodsSource }"/>
