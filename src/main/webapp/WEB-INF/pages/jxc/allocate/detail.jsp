...
<head>
    ...
    <script type="text/javascript">
		...
		function h2y_audit(){
			...
			var auditBean = "allocateBillAudit";
	...
	<form name="editform" method="post" action="" id="editform">
		...
		<table class="h2y_table" style="width:98%;">
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="exStorageId"  id="exStorageId" type="hidden" value="${billDetail.exportStorageId }"/>
					<div id="exStorageInfo">
						${billDetail.storageExport }
					</div>
				</td>
				...
				<td class="h2y_table_edit_td">
					<input name="inStorageId" id="inStorageId" type="hidden" value="${billDetail.importStorageId }"/>
					<div id="inStorageInfo">
						${billDetail.storageImport }
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="h2y_table_edit_td2" colspan="3">
					<input name="allocateDate" id="allocateDate" class="h2y_input_datetime" type="input" 
						value="<fmt:formatDate value="${billDetail.allocateDate }"  pattern="yyyy-MM-dd HH:mm"/>" disabled="disabled"/>
				</td>
			</tr>
						...
						<table class="h2y_table" id="billGoodsTable" style="width:100%;">
							...
							<c:forEach items="${billGoods }"  var="billGood">
								<tr id="billGoods_tr_${billGood.GOODS_ID }" class="billGoodsDetail">
    		  						<td class="h2y_table_edit_td">${billGood.GOODS_NICKNAME }<input name="billGoodsId" class="billGoodsId" type="hidden" value="${billGood.GOODS_ID }"/></td>
    		  						<td class="h2y_table_edit_td"><input name="costSinglePrice" id="billGoodsCostSinglePrice${billGood.GOODS_ID }" type="text" class="h2y_input_just" style="width:60px;"  value="${billGood.COST_SINGLE_PRICE }"  disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="allocateSinglePrice" id="billGoodsAllocateSinglePrice${billGood.GOODS_ID }" type="text" class="h2y_input_just" style="width:60px;"  value="${billGood.ALLOCATE_SINGLE_PRICE }"  disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="billGoodsCount" id="billGoodsCount${billGood.GOODS_ID }" type="text" class="h2y_input_just" style="width:60px;"  value="${billGood.GOODS_COUNT }"  disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="billGoodsTotalDifference" id="billGoodsTotalDifference${billGood.GOODS_ID }" class="h2y_input_just" type="text" class="h2y_input_just" style="width:100px;" value="${billGood.TOTAL_DIFFERENCE }" disabled="disabled"/></td>
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="totalDifference" id="totalDifference" type="text" class="h2y_input_just" value="${billDetail.totalDifference }"  disabled="disabled"/>
				</td>
			</tr>
