...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "jxc/allocate/getList.htm";
    ...
    //添加单据
    function h2y_add() {
        var src = "<%=basePath%>jxc/allocate/add.htm?op=add";
        top.f_addTab("allocate_add","添加仓库调拨单", src);
    }
    ...
    function h2y_billDetail(){
        ...
        var src = "<%=basePath%>jxc/allocate/getDetail.htm?billId="+rows[0].ID;
