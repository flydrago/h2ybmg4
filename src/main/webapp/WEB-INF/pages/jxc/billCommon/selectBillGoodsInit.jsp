	...
	<head>
		...
		<script type="text/javascript">
				...
				try{
					if(null!=parent.goodsDataJson && undefined!=parent.goodsDataJson){
						$(parent.goodsDataJson).each(function(){
							$("#objcolums").append("<option value=\""+this.ID+"\" iname=\""+this.NAME+"\" this=\""+this+"\">"+this.NAME+"</option>");
						});
					}
			...
			function f_query(){    
				...
				var url  = "jxc/billDetail/getGoodsList.htm";
				...
				$.post(url, params, function (data){
					...
					if(search_data.length>0){
						...
						$(search_data).each(function(){
							...
							$("#oAllsearchcolums").append("<option value=\""+this.ID+"\" iname=\""+this.NAME+"\" this=\""+this+"\">"+this.NAME+"</option>");
						});
					}
					show_title("oAllsearchcolums");
				});        
			...
			function searchgoods(){
				...
				$.post("jxc/billDetail/getGoodsList.htm",params,function (data){
