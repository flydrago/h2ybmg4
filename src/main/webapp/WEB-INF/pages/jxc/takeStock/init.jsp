...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "jxc/takeStock/getList.htm";
    ...
    //添加单据
    function h2y_add() {
        var src = "<%=basePath%>jxc/takeStock/add.htm?op=add";
        top.f_addTab("takeStock_add","添加盘点单", src);
    }
    ...
    function h2y_billDetail(){
        ...
        var src = "<%=basePath%>jxc/takeStock/getDetail.htm?billId="+rows[0].ID;
