...
<head>
    ...
    <script type="text/javascript">
		...
		function h2y_audit(){
			...
			var auditBean = "breakageBillAudit";
	...
	<form name="editform" method="post" action="" id="editform">
		...
		<table class="h2y_table" style="width:98%;">
			...
			<tr>
				...
				<td class="h2y_table_edit_td2" colspan="3">
					<input name="breakageDate" id="breakageDate" class="h2y_input_datetime" type="input" 
						value="<fmt:formatDate value="${billDetail.breakageDate }"  pattern="yyyy-MM-dd HH:mm"/>" disabled="disabled"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="h2y_table_edit_td2" colspan="3">
					<input name="excursus" id="excursus" type="text" class="h2y_input_long" value="${billDetail.excursus }" disabled="disabled"/>
				</td>
			</tr>
				...
				<td class="h2y_table_edit_td2" colspan="3" id="billGoods">
						<table class="h2y_table" id="billGoodsTable" style="width:100%;">
    						<tr>
    							...
    							<td class="h2y_table_label_td" style="text-align: center;">报损数量</td>
    							<td class="h2y_table_label_td" style="text-align: center;">报损金额</td>
    							<td class="h2y_table_label_td" style="text-align: center;">零售单价</td>
    							<td class="h2y_table_label_td" style="text-align: center;">零售金额</td>
    							<td class="h2y_table_label_td" style="text-align: center;">是否赠品</td>
							...
							<c:forEach items="${billGoods }"  var="billGood">
								<tr id="billGoods_tr_${billGood.goodsId }" class="billGoodsDetail">
    		  						...
    		  						<td class="h2y_table_edit_td"><input name="costSinglePrice" id="billGoodsCostSinglePrice${billGood.goodsId }" type="text" class="h2y_input_just" style="width:60px;"  value="${billGood.goodsCostPrice }"  disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="billGoodsBreakageCount" id="billGoodsBreakageCount${billGood.goodsId }" type="text" class="h2y_input_just" style="width:60px;"  value="${billGood.plCount }"  disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="billGoodsBreakageAmount" id="billGoodsBreakageAmount${billGood.goodsId }" class="h2y_input_just" type="text" style="width:100px;" value="${billGood.plAmount }" disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="retailSinglePrice" id="billGoodsRetailSinglePrice${billGood.goodsId }" class="h2y_input_just" type="text" style="width:60px;" value="${billGood.goodsRetailPrice }" disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="billGoodsRetailAmount" id="billGoodsRetailAmount${billGood.goodsId }" class="h2y_input_just" type="text" style="width:100px;" value="${billGood.retailAmount }" disabled="disabled"/></td>
    		  						<c:if test="${billGood.giftMark eq 0 }">
	    		  						<td class="h2y_table_edit_td" style="text-align:center;"><input name="billGoodsGiftMark" id="billGoodsGiftMark${billGood.goodsId }" type="checkbox" value="${billGood.giftMark }" disabled="disabled"/></td>
    		  						</c:if>
    		  						<c:if test="${billGood.giftMark eq 1 }">
	    		  						<td class="h2y_table_edit_td" style="text-align:center;"><input name="billGoodsGiftMark" id="billGoodsGiftMark${billGood.goodsId }" type="checkbox" value="${billGood.giftMark }" disabled="disabled" checked="checked"/></td>
    		  						</c:if>
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="breakageCount" id="breakageCount" type="text" class="h2y_input_just" disabled="disabled" value="${billDetail.breakageCount }"/>
				</td>
				...
				<td class="h2y_table_edit_td">
					<input name="breakageAmount" id="breakageAmount" type="text" class="h2y_input_just" value="${billDetail.breakageAmount }"  disabled="disabled"/>
				</td>
			</tr>
