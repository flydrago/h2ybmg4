...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "jxc/salesReturn/getList.htm";
    ...
    //添加单据
    function h2y_add() {
        var src = "<%=basePath%>jxc/salesReturn/add.htm?op=add";
        top.f_addTab("salesReturns_add","添加销售退货单", src);
    }
    ...
    function h2y_billDetail(){
        ...
        var src = "<%=basePath%>jxc/salesReturn/getDetail.htm?billId="+rows[0].ID;
