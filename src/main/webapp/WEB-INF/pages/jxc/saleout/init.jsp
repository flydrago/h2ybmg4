...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "jxc/saleout/getList.htm";
    ...
    //添加单据
    function h2y_add() {
        var src = "<%=basePath%>jxc/saleout/add.htm?op=add";
        top.f_addTab("saleout_add","添加销售出库单", src);
    }
    ...
    function h2y_billDetail(){
        ...
        var src = "<%=basePath%>jxc/saleout/getSaleoutDetail.htm?billId="+rows[0].ID;
