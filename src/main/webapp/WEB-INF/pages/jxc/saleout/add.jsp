    ...
    <script type="text/javascript">
    	...
    	function h2y_billGoodsSelectCallBack(data){
    	    ...
    	    if(data.length != 0){
    	  	  ...
    	  	  var checkedGoodsHtml = '<table class="h2y_table" width="100%" id="billGoodsTable">' +
    								  	 '<tr>'+
    								     ...
    								     '<td class="h2y_table_label_td" style="text-align: center;">销售单价</td>'+
    	...
    	function h2y_save(){
    		...
    		postData.outboundDate = $("#outboundDate").val();
    		...
    		$.post("jxc/saleout/outStorageSave.htm",{postData:JSON.stringify(postData)},function(res){
    			var resJson = eval("("+res+")");
    			if(resJson.resultFlag == 1 || resJson.resultFlag == "1"){
    				alert("单据添加成功。");
    				if (top.f_getframe("jxc_saleout_init_htm") != null) {
						top.f_getframe("jxc_saleout_init_htm").f_query();
					}
					top.f_delTab("saleout_add");
    			}else{
    				/* alert("单据添加失败，请联系管理员"); */
	...
	<form name="editform" method="post" action="" id="editform">
		...
		<table class="h2y_table" style="width:98%;">
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="outboundDate" id="outboundDate" class="h2y_input_datetime" type="input" 
						value="<fmt:formatDate value="${bill.outboundDate}"  pattern="yyyy-MM-dd HH:mm"/>"/>
				</td>
