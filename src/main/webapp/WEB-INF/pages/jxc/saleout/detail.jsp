...
<head>
    ...
    <script type="text/javascript">
		...
		function h2y_audit(){
			...
			var auditBean = "saleoutBillAudit";
	...
	<form name="editform" method="post" action="" id="editform">
		...
		<table class="h2y_table" style="width:98%;">
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="proceedsAccount" id="proceedsAccountId" type="hidden" value="${billDetail.proceedsAccountId }"/>
					<div id="proceedsAccountInfo">
						${billDetail.proceedsAccount }
					</div>
				</td>
				...
				<td class="h2y_table_edit_td">
					<input name="currentProceeds" id="currentProceeds" type="text"  class="h2y_input_just" value="${billDetail.currentProceeds }" disabled="disabled"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="outboundDate" id="outboundDate" class="h2y_input_datetime" type="input" 
						value="<fmt:formatDate value="${billDetail.outboundDate }"  pattern="yyyy-MM-dd HH:mm"/>" disabled="disabled"/>
				</td>
				...
				<td class="h2y_table_edit_td">
					<input name="proceedsDate" id="proceedsDate" class="h2y_input_datetime" type="input"
						value="<fmt:formatDate value="${billDetail.proceedsDate }"  pattern="yyyy-MM-dd HH:mm"/>" disabled="disabled"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="receivableAmount" id="receivableAmount" type="text" class="h2y_input_just" value="${billDetail.receivableAmount }" disabled="disabled" />
				</td>
