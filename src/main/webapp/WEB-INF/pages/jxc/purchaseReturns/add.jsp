...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
        	...
        	//打开 选择收支账户 对话窗
        	$("#choose_proceedsAccount_btn").click(function(){
    	...
    	function h2y_save(){
    		...
    		postData.proceedsDate = $("#proceedsDate").val();
    		postData.supplierId = $("#supplierId").val();
    		postData.storageId = $("#storageId").val();
    		postData.brokerId = $("#brokerId").val();
    		postData.proceedsAccountId = $("#proceedsAccountId").val();
    		postData.currentProceeds = $("#currentProceeds").val();
    		...
    		$.post("jxc/purchaseReturn/outStorageSave.htm",{postData:JSON.stringify(postData)},function(res){
    			...
    			if(resJson.resultFlag == 1 || resJson.resultFlag == "1"){
					...
					top.f_delTab("purchaseReturns_add");
    			}else{
	...
	<form name="editform" method="post" action="" id="editform">
		...
		<table class="h2y_table" style="width:98%;">
			...
			<tr>
				...
				<td class="h2y_table_label_td">
					<input type="button" value="出货仓库" class="button" id="choose_storage_btn"/>：
				</td>
				<td class="h2y_table_edit_td">
			...
			<tr>
				<td class="h2y_table_label_td">
					<input type="button" value="选择收款账户" class="button" id="choose_proceedsAccount_btn"/>：
				</td>
				<td class="h2y_table_edit_td">
				...
				<td class="h2y_table_edit_td">
					<input name="currentProceeds" id="currentProceeds" type="text" class="h2y_input_just"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="proceedsDate" id="proceedsDate" class="h2y_input_datetime" type="input"
						value="<fmt:formatDate value="${bill.proceedsDate}"  pattern="yyyy-MM-dd HH:mm"/>"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="receivableAmount" id="receivableAmount" type="text" class="h2y_input_just" disabled="disabled" />
				</td>
