...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "jxc/purchaseReturn/getList.htm";
    ...
    //添加单据
    function h2y_add() {
        var src = "<%=basePath%>jxc/purchaseReturn/add.htm?op=add";
        top.f_addTab("purchaseReturns_add","添加采购退货单", src);
    }
    ...
    function h2y_billDetail(){
        ...
        var src = "<%=basePath%>jxc/purchaseReturn/getDetail.htm?billId="+rows[0].ID;
