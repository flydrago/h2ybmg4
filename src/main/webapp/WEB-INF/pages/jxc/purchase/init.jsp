...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "jxc/purchase/getList.htm";
    ...
    //添加单据
    function h2y_add() {
        var src = "<%=basePath%>jxc/purchase/add.htm?op=add";
        top.f_addTab("receipts_add","添加采购入库单", src);
    }
    ...
    function h2y_billDetail(){
        ...
        var src = "<%=basePath%>jxc/purchase/getReceiptsDetail.htm?billId="+rows[0].ID;
