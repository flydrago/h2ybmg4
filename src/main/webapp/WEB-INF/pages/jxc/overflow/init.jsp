...
<script type="text/javascript">
    ...
    function f_getList() {
        ...
        var url_1 = "jxc/overflow/getList.htm";
    ...
    //添加单据
    function h2y_add() {
        var src = "<%=basePath%>jxc/overflow/add.htm?op=add";
        top.f_addTab("overflow_add","添加报溢单", src);
    }
    ...
    function h2y_billDetail(){
        ...
        var src = "<%=basePath%>jxc/overflow/getDetail.htm?billId="+rows[0].ID;
