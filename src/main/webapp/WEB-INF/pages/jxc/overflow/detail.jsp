...
<head>
    ...
    <script type="text/javascript">
		...
		function h2y_audit(){
			...
			var auditBean = "overflowBillAudit";
	...
	<form name="editform" method="post" action="" id="editform">
		...
		<table class="h2y_table" style="width:98%;">
			...
			<tr>
				...
				<td class="h2y_table_edit_td2" colspan="3">
					<input name="overflowDate" id="overflowDate" class="h2y_input_datetime" type="input" 
						value="<fmt:formatDate value="${billDetail.overflowDate }"  pattern="yyyy-MM-dd HH:mm"/>" disabled="disabled"/>
				</td>
			</tr>
				...
				<td class="h2y_table_edit_td2" colspan="3" id="billGoods">
						<table class="h2y_table" id="billGoodsTable" style="width:100%;">
    						<tr>
    							...
    							<td class="h2y_table_label_td" style="text-align: center;">报盈数量</td>
    							<td class="h2y_table_label_td" style="text-align: center;">报盈金额</td>
							...
							<c:forEach items="${billGoods }"  var="billGood">
								<tr id="billGoods_tr_${billGood.goodsId }" class="billGoodsDetail">
    		  						...
    		  						<td class="h2y_table_edit_td"><input name="billGoodsOverflowCount" id="billGoodsOverflowCount${billGood.goodsId }" type="text" class="h2y_input_just" style="width:60px;"  value="${billGood.plCount }"  disabled="disabled"/></td>
    		  						<td class="h2y_table_edit_td"><input name="billGoodsOverflowAmount" id="billGoodsOverflowAmount${billGood.goodsId }" class="h2y_input_just" type="text" style="width:100px;" value="${billGood.plAmount }" disabled="disabled"/></td>
			...
			<tr>
				...
				<td class="h2y_table_edit_td">
					<input name="overflowCount" id="overflowCount" type="text" class="h2y_input_just" disabled="disabled" value="${billDetail.overflowCount }"/>
				</td>
				...
				<td class="h2y_table_edit_td">
					<input name="overflowAmount" id="overflowAmount" type="text" class="h2y_input_just" value="${billDetail.overflowAmount }"  disabled="disabled"/>
				</td>
			</tr>
