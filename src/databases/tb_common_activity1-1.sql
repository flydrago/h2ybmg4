...
CREATE TABLE tb_common_activity (
  ...
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='活动主表（定义活动类型）';


-- ----------------------------
-- 活动主题关联表，关联活动下面的主题
-- ----------------------------
DROP TABLE IF EXISTS tb_common_activity_subject;
CREATE TABLE tb_common_activity_subject (
  id bigint(20) NOT NULL AUTO_INCREMENT,
  activity_id bigint(20) NOT NULL COMMENT '活动Id',
  subject_id varchar(50) not NULL COMMENT '主题Id',
  ord int(10) DEFAULT '0' COMMENT '活动中主题的排序',
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='活动主题关联表，关联活动下面的主题';
...
CREATE TABLE tb_common_subject (
  ...
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='活动主题主表（红酒专区、白酒专区等）';
...
CREATE TABLE tb_common_activity_goods (
  ...
  status int(2) DEFAULT '0' COMMENT '0：正常 1：不启用 2：删除',
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='活动或主题与商品的关联';


-- ----------------------------
-- Table structure for tb_common_activity_goods_his
-- ----------------------------
